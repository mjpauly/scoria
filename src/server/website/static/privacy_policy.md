...
Privacy is a big part of why Epsilon exists. Your location data reveals a
...
Epsilon's purpose is to help you privately collect and analyze your own personal
data. Data collected by the app is kept on your device and is only
accessible to you. Epsilon does not automatically collect any logged data, usage
statistics, or personally-identifiable information. Your private data will never
shared with anyone (including us) without your explicit consent.
...
Epsilon uses a third-party maps provider to show you maps in the app. The
...
Map areas you view in Epsilon are loaded from Maptiler's servers. When you open
...
servers. In Epsilon, private information displayed over the map is never sent to
Maptiler.
...
- Epsilon does not automatically collect any data from you.
- Epsilon will always ask for your explicit consent before sharing your data
with anyone.
