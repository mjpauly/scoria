...
See `src/app/android/README.md` for Android instructions.
...
Run `dev` once, taking note of the run directory printed. `cd` into it. Then
run:

```
rust-lldb /path/to/repo/bazel-bin/src/app/stem/dev
```
